...
def set_axes(ax, title, ymin, ymax, xmin, xmax, nolim):
    ...
    plt.tight_layout()
#####################
cable_length = '100'     #This is important change for every diferent length.
...
#######################
x_labels=[]
ff1="Plots/Redo_VNA/TP_1m_13_ChD3_ChCMD.vna"
ff2="Plots/Redo_VNA/TP_35cm_57_ChD1.vna"
ff3="Plots/Redo_VNA/TP_35cm_57_ChCMD.vna"
fullpath1 = ff1
...
with style.context('seaborn-ticks'):
    ...
    ax0.grid(True, color='0.4', which='minor')
...
plt.scatter(x_posi,y_plot_value)
for i, txt in enumerate(x_labels):
    ax5.annotate(txt, (x_posi[i],y_plot_value[i]))
ax5.set_xticklabels([])
plt.show()
